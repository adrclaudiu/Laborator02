...
//            }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        CheckBox checked = (CheckBox) findViewById(R.id.remember_me_checkbox);
        ...
        if (checked.isChecked()) {
            ...
            savedInstanceState.putBoolean(Constants.REMEMBER_ME_CHECKBOX, checked.isChecked());
        }
    }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState.containsKey(Constants.USERNAME_EDIT_TEXT)) {
            String usernameText = savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT);
            EditText usernameEditText = (EditText) findViewById(R.id.username_edit_text);
            usernameEditText.setText(usernameText);
        }
        if (savedInstanceState.containsKey(Constants.PASSWORD_EDIT_TEXT)) {
            String passwordText = savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT);
            EditText passwordEditText = (EditText) findViewById(R.id.password_edit_text);
